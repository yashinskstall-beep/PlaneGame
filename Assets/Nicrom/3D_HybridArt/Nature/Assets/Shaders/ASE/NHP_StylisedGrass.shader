...
Shader "Nicrom/NHP/ASE/Stylised Grass"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 objToWorld11_g71 = mul( unity_ObjectToWorld, float4( Pivot1504, 1 ) ).xyz;
			...
			float3 worldToObj35_g123 = mul( unity_WorldToObject, float4( appendResult14_g123, 1 ) ).xyz;
			float3 worldToObj36_g123 = mul( unity_WorldToObject, float4( float3( 0,0,0 ), 1 ) ).xyz;
...
Node;AmplifyShaderEditor.FunctionNode;1585;-2982.117,2452.388;Inherit;False;RotationAxis - NHP;-1;;123;b90648f17dcc4bc449d46e8cf04564ff;0;3;20;FLOAT;0;False;19;FLOAT;0;False;18;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;1477;-1049.371,1413.076;Inherit;False;Property;_Color1;Color 1;1;0;Create;True;0;0;0;False;0;False;0.3393185,0.490566,0.09255961,1;0.5754717,0.3435538,0.1465824,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;1476;-1053.57,1232.292;Inherit;False;Property;_Color2;Color 2;2;0;Create;True;0;0;0;False;0;False;0.719914,0.8207547,0.3639195,1;0.009433985,0.4014694,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=1AE16703540F87B8C6AA5EFAFA32B45F632A23B6